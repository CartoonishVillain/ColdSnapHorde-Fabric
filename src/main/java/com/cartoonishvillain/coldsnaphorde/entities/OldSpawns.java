...
//import com.cartoonishvillain.coldsnaphorde.mixin.BiomeAccessor;
...
//            ((BiomeAccessor) event).getColdSnapCategory();
//            boolean nether = Biome.getBiomeCategory(event).equals(Biome.BiomeCategory.SWAMP);
